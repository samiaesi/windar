...
| 03 | Product range | 18 references from the MASTER Italy catalogue (code, name, picture, product page), quote list. |
...
- Confirm the product selection (18 references from the MASTER catalogue) and mark the best sellers
